...
public class BoaTFT extends BOAagentBilateral 
{
	...
	public BoaTFT(NegotiationSession negoSession, UtilitySpace utilSpace) {
	...
	public void agentSetup() {
		...
		offeringStrategy = new NiceTitForTat_Offering();
		
		acceptConditions = new AC_NiceTitForTat(); //negotiationSession, offeringStrategy, 1, 0);	
