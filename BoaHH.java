...
public class BoaHH extends BOAagentBilateral 
{
	
	/**
	 * AcceptanceStrategy 	ac  = new AC_HardHeaded();
		OfferingStrategy 	os  = new HardHeaded_Offering();
		OpponentModel 		om  = new PerfectModel();
		OMStrategy			oms = new BestBid();
	 */
	private static final long serialVersionUID = 1L;

	public BoaHH(NegotiationSession negoSession, UtilitySpace utilSpace) {
	...
	public void agentSetup() {
		...
		offeringStrategy = new HardHeaded_Offering();
		
		acceptConditions = new AC_HardHeaded(); //negotiationSession, offeringStrategy, 1, 0);	
